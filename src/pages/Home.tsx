  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-primary-50/80 via-white to-primary-100 p-4 dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-950 dark:to-gray-800">
      ...
      <div className="flex flex-col md:flex-row gap-8 w-full max-w-2xl justify-center">
        ...
        >
          <Calculator className="h-14 w-14 text-primary-600 mb-4 group-hover:scale-110 transition dark:text-yellow-400" />
          <span className="text-2xl font-semibold text-primary-700 mb-2 dark:text-yellow-200">Simulador</span>
          <span className="text-primary-500 text-center dark:text-gray-300">Acesse o simulador de consórcio patrimonial.</span>
        </button>
        <button
