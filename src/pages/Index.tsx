      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 text-center space-y-6">
            <div className="inline-flex items-center space-x-2 bg-primary-100/70 text-primary-700 px-4 py-2 rounded-full text-sm font-medium">
            ...
            <p className="text-xl md:text-2xl text-secondary/70 max-w-3xl mx-auto leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 max-w-4xl mx-auto">
              <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
                ...
                <h3 className="font-semibold text-secondary mb-2">Cálculos Precisos</h3>
                <p className="text-secondary/60 text-sm">Algoritmos avançados para simulações realistas</p>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
                ...
                <h3 className="font-semibold text-secondary mb-2">Múltiplos Cenários</h3>
                <p className="text-secondary/60 text-sm">Compare diferentes estratégias de investimento</p>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
                ...
                <h3 className="font-semibold text-secondary mb-2">Metas Realistas</h3>
                <p className="text-secondary/60 text-sm">Defina objetivos alcançáveis para seu patrimônio</p>
              </div>
            </div>
          </div>
